...
import { DEVDOCK_COMMAND_NAME } from '../common/constants'
...
export const Symmetry = () => {
  ...
  const handleOpenSettings = () => {
    global.vscode.postMessage({
      type: DEVDOCK_COMMAND_NAME.settings
    })
  }
  ...
  return (
    <div className={styles.symmetryContainer}>
      ...
      <p>
        ...
        provider using your active devdock provider configuration. All
        ...
        <div className={styles.symmetryPanel}>
          ...
          {isProviderConnected && (
            <p>
              ...
              <a
                href="https://github.com/devdockdotdev/symmetry-cli"
                target="_blank"
                rel="noopener noreferrer"
              >
          ...
          <p>
            ...
            <a
              href="https://devdockdotdev.github.io/devdock-docs/general/symmetry"
              target="_blank"
              rel="noopener noreferrer"
            >
              documentation
